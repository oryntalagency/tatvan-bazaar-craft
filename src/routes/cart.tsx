    ...
    <SiteLayout>
      <section className="relative overflow-hidden">
        ...
        <div className="container-x relative py-20 text-primary-foreground">
          <h1 className="max-w-3xl font-display text-5xl md:text-6xl">Your Cart</h1>
          <p className="mt-3 text-lg text-primary-foreground/85">{cartWithProducts.length} item(s)</p>
        </div>
      </section>
